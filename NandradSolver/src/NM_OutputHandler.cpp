...
const char * const FLUX_QUANTITIES[] = {
	...
	"VentilationHeatLoad",
	"VentilationHeatFlux",
	"VentilationMoistureMassFlux",
	"CompleteThermalLoad",
	"CompleteMoistureLoad",
	...
	"FluxLongWaveRadiationBalanceA",
	"FluxLongWaveRadiationBalanceB",
	"FluxEmittedLongWaveRadiationA",
	"FluxEmittedLongWaveRadiationB",
...
void OutputHandler::writeOutputs(double t_out, double t_secondsOfYear, const std::map<std::string, std::string> & varSubstitutionMap) {
