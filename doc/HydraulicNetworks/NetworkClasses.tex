...
\begin{tikzpicture}[auto, node distance = 0.4cm, thick,
  ...
  \node (TNElem) [below = of TNImpl]  {\textbf{ThermalNetworkAbstractFlowElement}\\ \begin{itemize} \item meanTemperature \end{itemize}
  \textbf{ThermalNetworkAbstractFlowElement}\\ \textbf{WithHeatLoss}\\
  ...
  \node (HNElem)   [left = 2mm of Unten]          {\textbf{HydraulicNetworkAbstractElement} }; 
