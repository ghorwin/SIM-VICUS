...
[NOTE]
====
Die berechnete Kühlleistung hat ein negatives Vorzeichen!
====
...
- `IdealHeatingLoad [W]` (positiv)
- `IdealCoolingLoad [W]` (negativ)
...
Z. B. ist `Model<ZoneIdealHeatingCooling_id>).IdealHeatingLoad[id=3]` die Heizlast in Zone #3.
