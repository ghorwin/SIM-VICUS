...
| `VentilationRate` | 1/h | Konstante Luftwechselrate | {nbsp}>={nbsp}0.0{nbsp} | _erforderlich für constant-Modell_
|====================
...
Beispiel für einen Zeitplan, der den Parameter _InfiltrationRateSchedule_ bereitstellt
====
[source,xml]
----
