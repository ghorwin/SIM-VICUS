...
Im thermischen Modell kann für jeden Modelltyp noch ein (optionales) Wärmeaustauschmodell definiert werden (siehe <<NetworkHeatExchange>>).
...
<ControlElements>
	...
	-->
	<HydraulicNetworkControlElement id="1" controlledProperty="TemperatureDifference" controllerType="PController" >
