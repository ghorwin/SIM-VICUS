...
Im XML-Tag `HydraulicNetworkElement` des jeweiligen Rohres muss der Parameter `Temperature` gesetzt sein.

>> Anne/Hauke: Namensgebung "Temperature" zu unspezifisch.
...
Im XML-Tag `HydraulicNetworkElement` des jeweiligen Elements muss der Parameter `HeatFlux` gesetzt sein.
