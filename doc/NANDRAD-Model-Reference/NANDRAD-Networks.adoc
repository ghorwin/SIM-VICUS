...
Weiterhin werden verschiedene Parameter als Schedules benötigt: Ist der Modus `SourceSide` gewählt muss der Parameter `CondenserMeanTemperatureSchedule` als Schedule gegeben sein. 
