...
Der für eine Konstruktion gespeicherte Faktor ist immer exklusive aller eingebettete Objekte zu verstehen.  <<fig_shading_factor_example>> zeigt ein ähnliches Bild, jedoch einfacher zu berechnen.
...
Die Konstruktion hat eine Fläche von 18x8 = 144 m2. Das Fenster hat eine Fläche von 10x4 = 40 m2. Damit verbleibt für die Konstruktion eine
opaque Fläche von 144 - 40 = 104 m2. Der Schatten auf dem Fenster allein nimmt (13-(18-10)/2)x4 = 9x4 = 36 m2 ein. 
Der Verschattungsflächenfaktor für das Fenster allein beträgt also 90%. Die schattierte Fläche auf der opaken Fläche beträgt 104 - 36 = 68 m2.
er Abminderungsfaktor, der in der Gleichung für die Belastung durch die Sonneneinstrahlung verwendet werden muss beträgt also 68/104 = 65,4 %.

Die Werte *100% - 65,4% = 0.278* und *100% - 90% = 0.346* werden in der Datei für die schattierten Flächenanteile gespeichert.

Beachte: Die Gesamtkonstruktion (opque und nicht opaque) ist größer als die tatsächlich opaque Flächhe, und zwar 144 - 40 = 104 m2. Der Schatten auf der Gesamtkonstruktion nimmt 13x8 = 104 m2 ein, daher wäre der Schattenanteil (Faktor) für die Konstruktion: 104/144 = 72,2 %, also der flächengewichtete Faktor 40/144 * 90% + 104/144 * 65.4%.
