...
| `objectList` | Verweise auf eine Objektliste mit dem angegebenen Namen | string | _required_
|====================
...
[[fig_schedule_week]]
.Abbildung des wöchentlichen Zeitplans, definiert durch das Beispiel <<ex_schedule_week>>
