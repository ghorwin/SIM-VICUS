...
|`VentilationRate`|1/h|Austauschrate für natürliche Lüftung
|`VentilationRateIncrease`|1/h|Maximale Luftwechselrate = Offset für Nutzerkomfort
|`VentilationMaxAirTemperature`|C|Temperaturgrenzwert, unterhalb dessen die Komfortlüftung aktiviert wird
|`VentilationMinAirTemperature`|C|Temperaturgrenze, ab der die Komfortlüftung aktiviert wird
