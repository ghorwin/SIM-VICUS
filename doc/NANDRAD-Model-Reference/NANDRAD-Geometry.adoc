...
* `Ground` as ground zone (calculates temperature based on standard) | string | _optional_
...
|====================
| Name | Default Unit | Description | Value Range | Usage 
| `Orientation` | Deg | Orientation of the wall | [0, 360] Deg | _required_
| `Inclination` | Deg | Inclination of the wall (0 Deg - roof, 90 Deg - vertical wall, 180 Deg - facing downwards) | [0, 180] Deg| _required_
...
Interfaces are defining boundary conditions and parameters for the two surfaces `InterfaceA` and `InterfaceB` of a constructions instance.
