...
vorgegeben ist, während in _Active_ Zonen die Temperatur berechnet wird (d. h. in den
 ...
 Eine _konstante_ Zone benötigt entweder Temperaturparameter oder einen Temperaturzeitplan, aber keine weiteren Parameter. Der Zeitplan muss dabei
 ...
 Bei Vorliegen eines Zeitplans und eines Temperaturparameters überschreibt die Scheduledefinition den Parameter.
