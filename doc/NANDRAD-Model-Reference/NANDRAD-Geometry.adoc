...
Zones can be either _Constant_ or _Active_.
...
only used if `constant` | 0...1 | (_required_)
...
if one interface has outside boundary condition it is _required_  | 0...360 | _required_ / _optional_
| `Inclination` | Deg 
...
if one interface has outside boundary condition it is _required_ | 0...180 | _required_ / _optional_
