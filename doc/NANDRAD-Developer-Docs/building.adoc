...
The command will generate a set of `*.vcproj` files and an `sln` file. You can open that and start developing in VC. Just mind that you may need to update your project files whenever new files have been added to the SIM-VICUS source code.
