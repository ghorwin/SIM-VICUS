...
namespace VICUS {
	...
	const char * const ENUM_TYPES[24] = {
	...
	const char * theKeyword(int typenum, int t) {
		switch (typenum) {
			...
			switch (t) {
				...
				case 1 : return "InsideWall";
				case 2 : return "FloorWall";
			} break;
			// EPDDataset::para_t
			case 3 :
			switch (t) {
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			switch (t) {
				...
				case 1 : return "Interior construction";
				case 2 : return "Floor/ceiling construction";
			} break;
			// EPDDataset::para_t
			case 3 :
			switch (t) {
