...
namespace VICUS {
	...
	const char * const ENUM_TYPES[53] = {
	...
	const char * theKeyword(int typenum, int t) {
		switch (typenum) {
			...
			switch (t) {
				...
				case 7 : return "IdealHeatingCooling";
			} break;
		} // switch
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			case 18 :
			switch (t) {
				case 0 : return "Control the temperature difference at the flow element";
				case 1 : return "Control the mass flow of the flow element";
			} break;
			// NetworkController::ControllerType
			case 19 :
			switch (t) {
			...
			switch (t) {
				...
				case 7 : if (no_description != nullptr) *no_description = true; return "IdealHeatingCooling";
			} break;
		} // switch
