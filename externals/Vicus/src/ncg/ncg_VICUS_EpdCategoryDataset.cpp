	...
	try {
		...
		while (c) {
			...
			if (cName == "IBK:Parameter") {
				...
				try {
					m_module = (Module)KeywordList::Enumeration("EpdCategoryDataset::Module", c->GetText());
				}
...
TiXmlElement * EpdCategoryDataset::writeXML(TiXmlElement * parent) const {
	...
	if (m_module != NUM_M)
		TiXmlElement::appendSingleAttributeElement(e, "Module", nullptr, std::string(), KeywordList::Keyword("EpdCategoryDataset::Module",  m_module));
