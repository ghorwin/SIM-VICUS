...
void PlainGeometry::readXMLPrivate(const TiXmlElement * element) {
	FUNCID(PlainGeometry::readXMLPrivate);
	...
	try {
		...
		throw IBK::Exception( ex, IBK::FormatString("Error reading 'PlainGeometry' element."), FUNC_ID);
	}
	catch (std::exception & ex2) {
		throw IBK::Exception( IBK::FormatString("%1\nError reading 'PlainGeometry' element.").arg(ex2.what()), FUNC_ID);
	}
}

TiXmlElement * PlainGeometry::writeXMLPrivate(TiXmlElement * parent) const {
