...
namespace NANDRAD {
	...
	const char * const ENUM_TYPES[85] = {
		...
		"HydraulicNetworkComponent::arrayPara_t",
	...
	const char * theKeyword(int typenum, int t) {
		switch (typenum) {
			...
			case 11 :
			switch (t) {
				case 0 : return "PolyCoefficientsQCond";
				case 1 : return "PolyCoefficientsPel";
			} break;
			// HydraulicNetworkControlElement::modelType_t
			case 12 :
			switch (t) {
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			case 11 :
			switch (t) {
				case 0 : return "Polynom coefficients for condenser heat flux of heat pump";
				case 1 : return "Polynom coefficients for electrical power of heat pump";
			} break;
			// HydraulicNetworkControlElement::modelType_t
			case 12 :
			switch (t) {
