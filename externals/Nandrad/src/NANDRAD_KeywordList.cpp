...
namespace NANDRAD {
	...
	const char * const ENUM_TYPES[64] = {
	...
	const char * theKeyword(int typenum, int t) {
		switch (typenum) {
			...
			switch (t) {
				...
				case 9 : return "PipeMaxDiscretizationWidth";
			} break;
			// HydraulicNetworkComponent::HeatExchangeType
			case 9 :
			switch (t) {
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			case 5 :
			switch (t) {
				case 0 : return "Temperature in entire network is constant, and predefined";
				case 1 : return "A thermo-hydraulic network is calculated";
			} break;
			// HydraulicNetwork::para_t
			case 6 :
			switch (t) {
			...
			switch (t) {
				...
				case 7 : return "Coefficient of performance of the component.";
				case 8 : return "UA-Value of heat exchanger";
				case 9 : return "Maximum width of discretized volumes in pipe";
			} break;
			// HydraulicNetworkComponent::HeatExchangeType
			case 9 :
			switch (t) {
