...
namespace NANDRAD {
	...
	const char * const ENUM_TYPES[67] = {
	...
	const char * theKeyword(int typenum, int t) {
		switch (typenum) {
			...
			switch (t) {
				...
				case 6 : return "TemperatureFMUInterface";
			} break;
			// HydraulicNetworkHeatExchange::para_t
			case 11 :
			switch (t) {
	...
	const char * KeywordList::Description(const char * const enumtype, int t, bool * no_description) {
		...
		switch (enum2index(enumtype)) {
			...
			switch (t) {
				...
				case 6 : return "Difference to temperature from FMU interface, provided heat flux to FMU";
			} break;
			// HydraulicNetworkHeatExchange::para_t
			case 11 :
			switch (t) {
