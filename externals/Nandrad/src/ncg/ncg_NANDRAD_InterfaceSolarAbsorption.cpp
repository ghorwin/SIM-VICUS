...
void InterfaceSolarAbsorption::readXMLPrivate(const TiXmlElement * element) {
	FUNCID(InterfaceSolarAbsorption::readXMLPrivate);
	...
	try {
		...
		while (c) {
			...
			if (cName == "IBK:Parameter") {
				...
				bool success = false;
				try {
					para_t ptype = (para_t)KeywordList::Enumeration("InterfaceSolarAbsorption::para_t", p.name);
					m_para[ptype] = p;
...
TiXmlElement * InterfaceSolarAbsorption::writeXMLPrivate(TiXmlElement * parent) const {
