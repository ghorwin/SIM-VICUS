...
KeywordListQt::KeywordListQt() {
	...
	tr("A pump with constant pressure.");
	...
	tr("Pressure loss coefficient for the component.");
	...
	tr("Rated heating capacity of the component.");
	tr("Rated Cooling capacity of the component.");
	tr("Auxiliary power of the component.");
	tr("Water or air volume of the component.");
	tr("External surface area of the component.");
	tr("Convective fraction for heating or cooling.");
	tr("Coefficient of performance of the component.");
	tr("heat flux added by heat exchanger");
	tr("Fixed heat flux");
	...
	tr("Length for the element (pipe)");
	tr("Constant Value");
