...
public:
    ...
    */
    ...
    /*!
      ...
      \param samples Array of samples
      \note This is a virtual function to ensure that
         derived classes can update/reset their cached lazy-evaluation values
         that are based on samples (when this function is called on a base-class pointer).
    */
    virtual void setSamples( const QVector<T> &samples );
...
public:
    ...
    void setSamples( const QVector<QwtVectorSample> &samples );
