...
/*!
  ...
  The benefit of using QwtWeedingCurveFitter for screen display is limited, since
  the painter will optimize away polygons/paths anyway, that are drawn onto the
  same pixels. However, for exporting vector based graphics (PDF), the reduction
  in file size may be huge without noticable loss of plot quality.
*/
