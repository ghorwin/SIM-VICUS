#ifndef SOLFRA_PrecondPBPSH
#define SOLFRA_PrecondPBPSH
...
/*! A serial implementation of a banded preconditioner for use with Sundials solvers. */
class PrecondPBPS : public PrecondInterface {
public:
	/*! Initializes PrecondPBPS. */
...
private:
	...
	*/
	...
	/*! Number of PBPS operations. */
	unsigned int							m_statPrecondEvals;
};

} // namespace SOLFRA

#endif // SOLFRA_PrecondPBPS
