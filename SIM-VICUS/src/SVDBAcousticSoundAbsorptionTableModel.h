...
#define SVDBAcousticSoundAbsorptionTableModelH
...
*/
class SVDBAcousticSoundAbsorptionTableModel : public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	*/
	SVDBAcousticSoundAbsorptionTableModel(QObject * parent, SVDatabase & db);
...
#endif // SVDBAcousticSoundAbsorptionTableModelH
