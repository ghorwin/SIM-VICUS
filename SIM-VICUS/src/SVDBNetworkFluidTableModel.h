#ifndef SVDBNETWORKFLUIDTABLEMODEL_H
#define SVDBNETWORKFLUIDTABLEMODEL_H

#include "SVAbstractDatabaseEditWidget.h"

#include "SVDatabase.h"

class SVDBNetworkFluidTableModel: public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	/*! Constructor, requires a read/write pointer to the central database object.
		...
		*/
	SVDBNetworkFluidTableModel(QObject * parent, SVDatabase & db);
...
#endif // SVDBNETWORKFLUIDTABLEMODEL_H
