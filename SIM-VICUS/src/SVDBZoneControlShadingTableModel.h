...
#ifndef SVDBZoneControlShadingTableModelH
#define SVDBZoneControlShadingTableModelH
...
/*! Model for accessing the zone control Shading in database. */
class SVDBZoneControlShadingTableModel : public SVAbstractDatabaseTableModel {
public:
	...
	*/
	SVDBZoneControlShadingTableModel(QObject * parent, SVDatabase & db);
	...
	SVDatabase::DatabaseTypes databaseType() const override { return SVDatabase::DT_ZoneControlShading; }
...
#endif // SVDBZoneControlShadingTableModelH
