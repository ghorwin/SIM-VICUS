...
#ifndef SVDBSubSurfaceComponentTableModelH
#define SVDBSubSurfaceComponentTableModelH
...
/*! Model for accessing the sub-surfaces components in the database. */
class SVDBSubSurfaceComponentTableModel : public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	*/
	SVDBSubSurfaceComponentTableModel(QObject * parent, SVDatabase & db);
	...
	SVDatabase::DatabaseTypes databaseType() const override { return SVDatabase::DT_SubSurfaceComponents; }
...
#endif // SVDBSubSurfaceComponentTableModelH
