...
*/
class SVDBAcousticBoundaryConditionTableModel : public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	*/
	SVDBAcousticBoundaryConditionTableModel(QObject * parent, SVDatabase & db);
...
#endif // SVDBAcousticBoundaryConditionTableModelH
