...
#ifndef SVDBZoneIdealHeatingCoolingTableModelH
#define SVDBZoneIdealHeatingCoolingTableModelH
...
/*! Model for accessing the zone ideal heating/cooling in database. */
class SVDBZoneIdealHeatingCoolingTableModel : public SVAbstractDatabaseTableModel {
public:
	...
	*/
	SVDBZoneIdealHeatingCoolingTableModel(QObject * parent, SVDatabase & db);
	...
	SVDatabase::DatabaseTypes databaseType() const override { return SVDatabase::DT_ZoneIdealHeatingCooling; }
...
#endif // SVDBZoneIdealHeatingCoolingTableModelH
