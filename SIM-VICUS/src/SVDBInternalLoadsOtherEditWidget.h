...
#ifndef SVDBInternalLoadsOtherEditWidgetH
#define SVDBInternalLoadsOtherEditWidgetH

#include "SVAbstractDatabaseEditWidget.h"

namespace Ui {
	class SVDBInternalLoadsOtherEditWidget;
}
...
class SVDBInternalLoadsOtherEditWidget : public SVAbstractDatabaseEditWidget {
	Q_OBJECT

public:
	explicit SVDBInternalLoadsOtherEditWidget(QWidget *parent = nullptr);
	~SVDBInternalLoadsOtherEditWidget() override;
...
private slots:
	...
	void on_lineEditPower_editingFinishedSuccessfully();
...
private:
	...
	Ui::SVDBInternalLoadsOtherEditWidget	*m_ui;
...
#endif // SVDBInternalLoadsOtherEditWidgetH
