...
#ifndef SVDBWindowTableModelH
#define SVDBWindowTableModelH
...
class SVDBWindowTableModel : public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	/*! Constructor, requires a read/write pointer to the central database object.
		...
		*/
	SVDBWindowTableModel(QObject * parent, SVDatabase & db);
