...
#ifndef SVDBSupplySystemTableModelH
#define SVDBSupplySystemTableModelH
...
*/
class SVDBSupplySystemTableModel : public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	*/
	SVDBSupplySystemTableModel(QObject * parent, SVDatabase & db);
	...
	SVDatabase::DatabaseTypes databaseType() const override { return SVDatabase::DT_SupplySystems; }
...
#endif // SVDBSupplySystemTableModelH
