...
void SVDBAcousticBoundaryConditionEditWidget::on_lineEditHeatTransferCoefficient_editingFinished() {
	Q_ASSERT(m_current != nullptr);
...
void SVDBAcousticBoundaryConditionEditWidget::on_lineEditSolarAbsorptionCoefficient_editingFinished() {
	Q_ASSERT(m_current != nullptr);
...
void SVDBAcousticBoundaryConditionEditWidget::on_lineEditLongWaveEmissivity_editingFinished() {
	Q_ASSERT(m_current != nullptr);
...
void SVDBAcousticBoundaryConditionEditWidget::on_comboBoxHeatTransferCoeffModelType_currentIndexChanged(int index) {
	Q_ASSERT(m_current != nullptr);
	// update database but only if different from original
...
void SVDBAcousticBoundaryConditionEditWidget::on_comboBoxLWModelType_currentIndexChanged(int index) {
	Q_ASSERT(m_current != nullptr);
	// update database but only if different from original
...
void SVDBAcousticBoundaryConditionEditWidget::on_comboBoxSWModelType_currentIndexChanged(int index) {
	Q_ASSERT(m_current != nullptr);
	// update database but only if different from original
...
void SVDBAcousticBoundaryConditionEditWidget::on_comboBoxConnectedZoneType_currentIndexChanged(int index) {
...
void SVDBAcousticBoundaryConditionEditWidget::on_toolButtonSelectTemperatureSchedule_clicked() {
...
void SVDBAcousticBoundaryConditionEditWidget::on_toolButtonRemoveTemperatureSchedule_clicked() {
...
void SVDBAcousticBoundaryConditionEditWidget::on_lineEditZoneConstTemperature_editingFinishedSuccessfully() {
