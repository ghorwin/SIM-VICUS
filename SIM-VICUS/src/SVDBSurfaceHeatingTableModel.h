...
#ifndef SVDBSurfaceHeatingTableModelH
#define SVDBSurfaceHeatingTableModelH
...
class SVDBSurfaceHeatingTableModel : public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	*/
	SVDBSurfaceHeatingTableModel(QObject * parent, SVDatabase & db);
	...
	SVDatabase::DatabaseTypes databaseType() const override { return SVDatabase::DT_SurfaceHeating; }
...
#endif // SVDBSurfaceHeatingTableModelH
