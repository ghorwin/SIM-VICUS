...
void SVDBInternalLoadsLightsEditWidget::on_lineEditPower_editingFinished() {
	Q_ASSERT(m_current != nullptr);
...
void SVDBInternalLoadsLightsEditWidget::on_lineEditConvectiveFactor_editingFinished() {
	Q_ASSERT(m_current != nullptr);
