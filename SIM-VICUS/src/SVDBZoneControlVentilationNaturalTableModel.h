...
#ifndef SVDBZoneControlVentilationNaturalTableModelH
#define SVDBZoneControlVentilationNaturalTableModelH
...
/*! Model for accessing the zone control ventilation natural in database. */
class SVDBZoneControlVentilationNaturalTableModel : public SVAbstractDatabaseTableModel {
	Q_OBJECT
public:
	...
	*/
	SVDBZoneControlVentilationNaturalTableModel(QObject * parent, SVDatabase & db);
	...
	SVDatabase::DatabaseTypes databaseType() const override { return SVDatabase::DT_ZoneControlNaturalVentilation; }
...
#endif // SVDBZoneControlVentilationNaturalTableModelH
